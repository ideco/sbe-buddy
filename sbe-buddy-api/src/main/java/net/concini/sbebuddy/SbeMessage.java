 ...
 *
 * <p>
 * The generated codec encodes the following parts in order:
 * </p>
 * <ol>
...
public @interface SbeMessage {
	...
	/**
	 * The message name in the schema. An empty value uses the record's simple name.
	 */
	String name() default "";
	...
	/**
	 * A semantic type label for the message. Empty means unspecified.
	 */
	String semanticType() default "";

	/**
	 * A description of the message. Empty means unspecified.
	 */
	...
	/**
	 * The schema version in which the message was deprecated. Zero means
	 * unspecified. Deprecation does not remove the message.
	 */
	int deprecated() default 0;

	/**
	 * The wire order of record components and {@linkplain #unmapped() unmapped
	 * fields}. Names refer to Java record components or to the declared names of
	 * unmapped fields.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * This controls the schema layout without changing the record's constructor
	 * order. In schema-first mode, the resulting layout must match the XML.
	 * </p>
	 */
